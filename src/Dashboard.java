...
public class Dashboard extends javax.swing.JFrame {
    ...
    private void btnSearchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSearchActionPerformed
        ...
        Object[] product = getProductByName(selectedName);
        if (product != null) {
    ...
    private void btnAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddActionPerformed
        ...
        try {
            ...
            boolean success = addProduct(name, price, qty, code, supplier);
            if (success) {
    ...
    private void btnUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateActionPerformed
        ...
        try {
            double price = Double.parseDouble(priceStr);
            int qty = Integer.parseInt(qtyStr);
            boolean success = updateProduct(currentProductId, name, price, qty, code, supplier);
            if (success) {
    ...
    private void btnDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteActionPerformed
        ...
        if (confirm == javax.swing.JOptionPane.YES_OPTION) {
            boolean success = deleteProduct(currentProductId);
            if (success) {
    ...
    private void loadProductNamesToComboBox() {
        ...
        for (String name : getAllProductNames()) {
            cbProductSearch.addItem(name);
        }
    }

    private void exportProductsToTxt() {
        java.util.List<Object[]> products = getAllProducts();
